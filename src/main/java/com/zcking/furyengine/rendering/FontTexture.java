...
public class FontTexture {
    ...
    private void buildTexture() throws Exception {
        ...
        // Create the image associated with the charset
        ...
        // TODO: replace all this with the stb usage
        InputStream is;
        try (ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ImageIO.write(img, IMAGE_FORMAT, out); // ImageIO.write(img, IMAGE_FORMAT, new java.io.File("Temp.png");
            out.flush();
