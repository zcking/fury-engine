...
import com.zcking.furyengine.engine.graph.particles.FlowParticleEmitter;
...
public class ParticlesDemo implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        GameObject quadGameObject = new GameObject(quadMesh);
        quadGameObject.setPosition(0, 0, 0);
        quadGameObject.setScale(2.5f);

        scene.setGameObjects(new GameObject[] { quadGameObject} );
    ...
    public static void main(String[] args) {
        try {
            IGameLogic gameLogic = new ParticlesDemo();
            WindowSettings windowSettings = WindowSettings.create()
                    ...
                    .withInitialTitle("Particles Demo");
