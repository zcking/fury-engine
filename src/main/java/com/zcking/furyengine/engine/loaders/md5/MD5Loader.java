...
/**
 * NOTE: This parser and this entire package (com.zcking.furyengine.engine.loaders.md5)
 * are currently borrowed from the "3D Game Development with LWJGL 3"
 * found here: https://lwjglgamedev.gitbooks.io/3d-game-development-with-lwjgl/content/chapter19/chapter19.html
 *
 * All credit and licensing for this loader are attributed to the author(s) of this book.
 */
public class MD5Loader {
    ...
    public static AnimGameObject process(MD5Model md5Model, MD5AnimModel animModel, Vector4f defaultColour) throws Exception {
        ...
        return new AnimGameObject(meshes, animatedFrames, invJointMatrices);
    }

    private static List<Matrix4f> calcInvJointMatrices(MD5Model md5Model) {
        ...
        for (MD5JointInfo.MD5JointData joint : joints) {
            ...
            // Gets transformation matrix by multiplying translation matrix by rotation matrix
